...
public class DELETE_OBSTACLETest {
	...
	@Test
	public void test_delete_obstacle_01() {
		...
		DELETE_OBSTACLE dob = new DELETE_OBSTACLE(machine);
		dob.run_DELETE_OBSTACLE(Obs);
		assertFalse(machine.get_obstacles().has(Obs));				
	}
